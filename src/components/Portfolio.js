    ...
    const content = (
      <>
        ...
        <a
          ...
          onClick={() =>
            window.open("https://www.npmjs.com/package/react-popupbox")
          }
        >
    ...
    <div id="portfolio" className="portfolio-wrapper">
      <div className="container">
        ...
        <div className="image-box-wrapper row justify-content-center">
          <div
            className="portfolio-image-box col-lg-3 col-md-4 col-sm-6"
            onClick={openPopupbox}
          >
            <img className="portfolio-image" src={Sample} alt="" />
